...
local name ="postREStat_rd_amenities_mtlines" // <--- change when necessry
...
esttab road_du road_duhe road_mfdu road_mf road_mfhe road_he using "$RDPATH/amenities_table_road.tex", replace keep(i25.dist3) ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
...
esttab river_du river_duhe river_mfdu river_mf river_mfhe river_he using "$RDPATH/amenities_table_river.tex", replace keep(i25.dist3) ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
...
esttab space_du space_duhe space_mfdu space_mf space_mfhe space_he using "$RDPATH/amenities_table_space.tex", replace keep(i25.dist3) ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
...
esttab school_du school_duhe school_mfdu school_mf school_mfhe school_he using "$RDPATH/amenities_table_school.tex", replace keep(i25.dist3) ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
...
esttab center_du center_duhe center_mfdu center_mf center_mfhe center_he using "$RDPATH/amenities_table_center.tex", replace keep(i25.dist3) ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
...
esttab transit_du transit_duhe transit_mfdu transit_mf transit_mfhe transit_he using "$RDPATH/amenities_table_transit.tex", replace keep(i25.dist3) ///
se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
...
esttab slope_du slope_duhe slope_mfdu slope_mf slope_mfhe slope_he using "$RDPATH/amenities_table_slope.tex", replace keep(i25.dist3) ///
se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
...
esttab slope15_du slope15_duhe slope15_mfdu slope15_mf slope15_mfhe slope15_he using "$RDPATH/amenities_table_slope15.tex", replace keep(i25.dist3) ///
se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
...
local b1_title "<-More restrictive  |  Less restrictive ->"
local b2_title "Distance to Boundary (miles)"
local graph_title "coef_slope15_all"
...
esttab depth_du depth_duhe depth_mfdu depth_mf depth_mfhe depth_he using "$RDPATH/amenities_table_depth.tex", replace keep(i25.dist3) ///
se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
...
esttab sand_du sand_duhe sand_mfdu sand_mf sand_mfhe sand_he using "$RDPATH/amenities_table_sand.tex", replace keep(i25.dist3) ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
...
esttab clay_du clay_duhe clay_mfdu clay_mf clay_mfhe clay_he using "$RDPATH/amenities_table_clay.tex", replace keep(i25.dist3) ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
...
esttab clay_du clay_duhe clay_mfdu clay_mf clay_mfhe clay_he using "$RDPATH/amenities_table_walkability.tex", replace keep(i25.dist3) ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
...
local b1_title "<-More restrictive  |  Less restrictive ->"
local b2_title "Distance to Boundary (miles)"
local graph_title "coef_walk_all"
...
esttab empl_du empl_duhe empl_mfdu empl_mf empl_mfhe empl_he using "$RDPATH/amenities_table_emplmix.tex", replace keep(i25.dist3) ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
...
esttab emplrank_du emplrank_duhe emplrank_mfdu emplrank_mf emplrank_mfhe emplrank_he using "$RDPATH/amenities_table_emplrank.tex", replace keep(i25.dist3) ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
