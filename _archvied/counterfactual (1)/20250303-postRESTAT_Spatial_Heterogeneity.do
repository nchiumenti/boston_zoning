...
*NEW 3.3.2025 need to add 0.02 values of these
...
foreach l of local levels {
	...
	*****loop over different bandwidth
	foreach d of numlist 0.02 0.2 {       /**NEW 3.3.2025*/
	...
	********************************************************************************	
	...
	quietly foreach d of numlist 0.02 0.2 {    /**NEW 3.3.2025*/
...
* direct effects, only_du
quietly foreach var of numlist 2 20 {      /*NEW 3.3.2025 */ 
	forvalues i = 1(2)3 {
