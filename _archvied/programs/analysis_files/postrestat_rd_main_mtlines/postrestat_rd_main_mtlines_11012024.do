...
*
*			Contents:
*				Part 1(a-b): Units >=1918
*				Part 2(a-b): Units >=1956
*				Part 3(a-b): Units, no year restriction
*				Part 4(a-b): Sales prices
*				Part 5(a-b): Land prices
*				Part 6(a-b): Rents
*				Part 7(a-b): Vacant land prices
* 				
...
* Part 1b: units >=1918, w/ characteristics
********************************************************************************
** regressions
...
* Part 1b: units >=1918, w/ characteristics
quietly eststo units_du2: reg num_units1 ib26.dist3 i.lam_seg $char_vars if only_du == 1 & `regression_conditions', vce(cluster lam_seg)
	
quietly eststo units_duhe2: reg num_units1 ib26.dist3 i.lam_seg $char_vars if du_he == 1 & `regression_conditions', vce(cluster lam_seg)

quietly eststo units_mfdu2: reg num_units1 ib26.dist3 i.lam_seg $char_vars if mf_du == 1 & `regression_conditions', vce(cluster lam_seg)

quietly eststo units_mf2: reg num_units1 ib26.dist3 i.lam_seg $char_vars if only_mf== 1 & `regression_conditions', vce(cluster lam_seg)

quietly eststo units_mfhe2: reg num_units1 ib26.dist3 i.lam_seg $char_vars if mf_he == 1 & `regression_conditions', vce(cluster lam_seg)

quietly eststo units_he2: reg num_units1 ib26.dist3 i.lam_seg $char_vars if only_he == 1 & `regression_conditions', vce(cluster lam_seg)

esttab units_du2 units_duhe2 units_mfdu2 units_mf2 units_mfhe2 units_he2, ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year Built f.e.=*year_built") interaction(" X ") ///
	label mtitles("units_du2" "units_duhe2" "units_mfdu2" "units_mf2" "units_mfhe2" "units_he2") ///
	title("Units >=1918, w/ characteristics") 
	
*robust s.e.
quietly eststo units_du2_robust: reg num_units1 ib26.dist3 i.lam_seg $char_vars if only_du == 1 & `regression_conditions', vce(robust)
	
quietly eststo units_duhe2_robust: reg num_units1 ib26.dist3 i.lam_seg $char_vars if du_he == 1 & `regression_conditions', vce(robust)

quietly eststo units_mfdu2_robust: reg num_units1 ib26.dist3 i.lam_seg $char_vars if mf_du == 1 & `regression_conditions', vce(robust)

quietly eststo units_mf2_robust: reg num_units1 ib26.dist3 i.lam_seg $char_vars if only_mf== 1 & `regression_conditions', vce(robust)

quietly eststo units_mfhe2_robust: reg num_units1 ib26.dist3 i.lam_seg $char_vars if mf_he == 1 & `regression_conditions', vce(robust)

quietly eststo units_he2_robust: reg num_units1 ib26.dist3 i.lam_seg $char_vars if only_he == 1 & `regression_conditions', vce(robust)

esttab units_du2_robust units_duhe2_robust units_mfdu2_robust units_mf2_robust units_mfhe2_robust units_he2_robust, ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year Built f.e.=*year_built") interaction(" X ") ///
	label mtitles("units_du2" "units_duhe2" "units_mfdu2" "units_mf2" "units_mfhe2" "units_he2") ///
	title("Units >=1918, w/ characteristics, robust s.e.") 
...
* coefplots, units >=1918 w/ characteristics
{
local plot_list units_du units_duhe units_mfdu units_mf units_mfhe units_he
local suffix "coef_units_1918_char"
local l1_title "Number of Units"
local b1_title "<- More restrictive  |  Less restrictive ->"
local b2_title "Distance to Boundary (miles)"
...
* combine all
#delimit ;
graph combine units_du2 units_duhe2 units_mfdu2 units_mf2 units_mfhe2 units_he2,
	rows(3) cols(2) ysize() xsize() iscale() imargin(0)
	graphregion(fc(white) lcolor(white))
	l1title("{bf:`l1_title'}", size(3) margin(t=0 b=0 l=0 r=1))
	b1title("`b1_title'", size(2))
...
* coefplots, units >=1918 both
{
local plot_list units_du units_duhe units_mfdu units_mf units_mfhe units_he
local suffix "coef_units_1918_both"
local l1_title "Number of Units"
local b1_title "<- More restrictive  |  Less restrictive ->"
local b2_title "Distance to Boundary (miles)"
...
* combine all
#delimit ;
graph combine units_du3 units_duhe3 units_mfdu3 units_mf3 units_mfhe3 units_he3,
	rows(3) cols(2) ysize() xsize() iscale() imargin(0)
	graphregion(fc(white) lcolor(white))
	l1title("{bf:`l1_title'}", size(3) margin(t=0 b=0 l=0 r=1))
	b1title("`b1_title'", size(2))
...
esttab units_du2 units_duhe2 units_mfdu2 units_mf2 units_mfhe2 units_he2, ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year Built f.e.=*year_built") interaction(" X ") ///
	label mtitles("units_du2" "units_duhe2" "units_mfdu2" "units_mf2" "units_mfhe2" "units_he2") ///
	title("Units >=1956, w/ characteristics") 
...
esttab units_du2_robust units_duhe2_robust units_mfdu2_robust units_mf2_robust units_mfhe2_robust units_he2_robust, ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year Built f.e.=*year_built") interaction(" X ") ///
	label mtitles("units_du2" "units_duhe2" "units_mfdu2" "units_mf2" "units_mfhe2" "units_he2") ///
	title("Units >=1956, w/ characteristics, robust s.e.") 
...
* coefplots, units >=1956 w/ characteristics
{
local plot_list units_du units_duhe units_mfdu units_mf units_mfhe units_he
local suffix "coef_units_1956_char"
local l1_title "Number of Units"
local b1_title "<- More restrictive  |  Less restrictive ->"
local b2_title "Distance to Boundary (miles)"
...
* coefplots, units >=1956 both
{
local plot_list units_du units_duhe units_mfdu units_mf units_mfhe units_he
local suffix "coef_units_1956_both"
local l1_title "Number of Units"
local b1_title "<- More restrictive  |  Less restrictive ->"
local b2_title "Distance to Boundary (miles)"
...
* Part 3b: units no year restriction, w/ characteristics
********************************************************************************
** regressions
* set regression conditions
...
esttab units_du2 units_duhe2 units_mfdu2 units_mf2 units_mfhe2 units_he2, ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year Built f.e.=*year_built") interaction(" X ") ///
	label mtitles("units_du2" "units_duhe2" "units_mfdu2" "units_mf2" "units_mfhe2" "units_he2") ///
	title("Units, w/ characteristics") 
	
* export table version 	
esttab units_du2 units_duhe2 units_mfdu2 units_mf2 units_mfhe2 units_he2 using "$RDPATH/units_noyear_chars_table.tex", replace keep(25.dist3) ///
	se r2 indicate("Boundary f.e.=*lam_seg""Year Built f.e.=*year_built") interaction(" X ") ///
	label mtitles("units_du" "units_duhe" "units_mfdu" "units_mf" "units_mfhe" "units_he") ///
	title("Units, baseline") 	
...
esttab units_du2_robust units_duhe2_robust units_mfdu2_robust units_mf2_robust units_mfhe2_robust units_he2_robust, ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year Built f.e.=*year_built") interaction(" X ") ///
	label mtitles("units_du2" "units_duhe2" "units_mfdu2" "units_mf2" "units_mfhe2" "units_he2") ///
	title("Units, w/ characteristics, robust s.e.") 
...
* coefplots, units no year restriction, w/ characteristics
{
local plot_list units_du units_duhe units_mfdu units_mf units_mfhe units_he
local suffix "coef_units_noyear_char"
local l1_title "Number of Units"
local b1_title "<- More restrictive  |  Less restrictive ->"
local b2_title "Distance to Boundary (miles)"
...
* coefplots, units no year restrictions, both
{
local plot_list units_du units_duhe units_mfdu units_mf units_mfhe units_he
local suffix "coef_units_noyear_both"
local l1_title "Number of Units"
local b1_title "<- More restrictive  |  Less restrictive ->"
local b2_title "Distance to Boundary (miles)"
...
* Part 5b: Land prices, characteristics (land characteristics)
********************************************************************************
** regressions

/* NC notes: new postREStat version creates log of land value, controlling for
tax year fixed effects, and regs on all properties, less condos, if land value
is present */
...
* Part 5b: Land price w/ characteristis (need to control for soil characteristics here and amenities not house characteirstics)
quietly eststo land_du2: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year $char_vars_land if only_du==1 & `regression_conditions', vce(cluster lam_seg)
	
quietly eststo land_duhe2: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year $char_vars_land if du_he == 1 & `regression_conditions', vce(cluster lam_seg)

quietly eststo land_mfdu2: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year $char_vars_land if  mf_du == 1 & `regression_conditions', vce(cluster lam_seg)

quietly eststo land_mf2: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year $char_vars_land if only_mf== 1 & `regression_conditions', vce(cluster lam_seg)

quietly eststo land_mfhe2: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year $char_vars_land if mf_he == 1 & `regression_conditions', vce(cluster lam_seg)

quietly eststo land_he2: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year $char_vars_land if only_he == 1 & `regression_conditions', vce(cluster lam_seg)
	
esttab land_du2 land_duhe2 land_mfdu2 land_mf2 land_mfhe2 land_he2, ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
	label mtitles("land_du" "land_duhe" "land_mfdu" "land_mf" "land_mfhe" "land_he") ///
	title("Land price per squarefoot w/ characteristics") 
	// Eli: price_he2 -> land_he2
* export table version 	
esttab land_du2 land_duhe2 land_mfdu2 land_mf2 land_mfhe2 land_he2 using "$RDPATH/land_price_char_table.tex", replace keep(25.dist3) ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
	label mtitles("land_du" "land_duhe" "land_mfdu" "land_mf" "land_mfhe" "land_he") ///
	title("Assessed Land Value Per Squarefoot")	
	
*robust s.e.
quietly eststo land_du2_robust: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year $char_vars_land if only_du==1 & `regression_conditions', vce(robust)
	
quietly eststo land_duhe2_robust: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year $char_vars_land if du_he == 1 & `regression_conditions', vce(robust)

quietly eststo land_mfdu2_robust: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year $char_vars_land if  mf_du == 1 & `regression_conditions', vce(robust)

quietly eststo land_mf2_robust: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year $char_vars_land if only_mf== 1 & `regression_conditions', vce(robust)

quietly eststo land_mfhe2_robust: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year $char_vars_land if mf_he == 1 & `regression_conditions', vce(robust)

quietly eststo land_he2_robust: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year $char_vars_land if only_he == 1 & `regression_conditions', vce(robust)
	
esttab land_du2_robust land_duhe2_robust land_mfdu2_robust land_mf2_robust land_mfhe2_robust land_he2_robust, ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
	label mtitles("land_du" "land_duhe" "land_mfdu" "land_mf" "land_mfhe" "land_he") ///
	title("Land Price w/ characteristics, robust s.e.") 
...
* coefplots, land prices w/ characteristics
{
local plot_list land_du land_duhe land_mfdu land_mf land_mfhe land_he
local suffix "coef_land_char"
local l1_title "Log Land Price"
local b1_title "<- More restrictive  |  Less restrictive ->"
local b2_title "Distance to Boundary (miles)"
...
* combine all
#delimit ;
graph combine land_du2 land_duhe2 land_mfdu2 land_mf2 land_mfhe2 land_he2,
	rows(3) cols(2) ysize() xsize() iscale() imargin(0)
	graphregion(fc(white) lcolor(white))
	l1title("{bf:`l1_title'}", size(3) margin(t=0 b=0 l=0 r=1))
	b1title("`b1_title'", size(2))
...
* combine all
#delimit ;
graph combine land_du3 land_duhe3 land_mfdu3 land_mf3 land_mfhe3 land_he3,
	rows(3) cols(2) ysize() xsize() iscale() imargin(0)
	graphregion(fc(white) lcolor(white))
	l1title("{bf:`l1_title'}", size(3) margin(t=0 b=0 l=0 r=1))
	b1title("`b1_title'", size(2))
...
** regressions
*REGRESSION CONDITIONS, SF HOMES ONLY

* set regression conditions
local regression_conditions (year>=2010 & year<=2018) & (dist_both<=0.21 & dist_both>=-0.2) & res_typex=="Single Family Res" & assd_landval !=0

* Part 5c: Land value w/o characteristics
quietly eststo land_du: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if only_du==1 & `regression_conditions', vce(cluster lam_seg)
sum land_per_sqft if only_du == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex=="Single Family Res" & assd_landval !=0
sum land_per_sqft if only_du == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex=="Single Family Res" & assd_landval !=0
	
quietly eststo land_duhe: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if du_he == 1 & `regression_conditions', vce(cluster lam_seg)
sum land_per_sqft if du_he == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex=="Single Family Res" & assd_landval !=0
sum land_per_sqft if du_he == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex=="Single Family Res" & assd_landval !=0

quietly eststo land_mfdu: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if  mf_du == 1 & `regression_conditions', vce(cluster lam_seg)
sum land_per_sqft if mf_du == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex=="Single Family Res" & assd_landval !=0
sum land_per_sqft if mf_du == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex=="Single Family Res" & assd_landval !=0

quietly eststo land_mf: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if only_mf== 1 & `regression_conditions', vce(cluster lam_seg)
sum land_per_sqft if only_mf == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex=="Single Family Res" & assd_landval !=0
sum land_per_sqft if only_mf == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex=="Single Family Res" & assd_landval !=0

quietly eststo land_mfhe: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if mf_he == 1 & `regression_conditions', vce(cluster lam_seg)
sum land_per_sqft if mf_he == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex=="Single Family Res" & assd_landval !=0
sum land_per_sqft if mf_he == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex=="Single Family Res" & assd_landval !=0

quietly eststo land_he: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if only_he == 1 & `regression_conditions', vce(cluster lam_seg)
sum land_per_sqft if only_he == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex=="Single Family Res" & assd_landval !=0
sum land_per_sqft if only_he == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex=="Single Family Res" & assd_landval !=0
...
* export table version 	
esttab land_du land_duhe land_mfdu land_mf land_mfhe land_he using "$RDPATH/land_price_table_onlysf.tex", replace keep(25.dist3) ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
	label mtitles("land_du" "land_duhe" "land_mfdu" "land_mf" "land_mfhe" "land_he") ///
	title("Assessed Land Value Per Squarefoot")	
...
* Part 5d: Land price w/ characteristis (need to control for soil characteristics here and amenities not house characteirstics)
quietly eststo land_du2: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year $char_vars_land if only_du==1 & `regression_conditions', vce(cluster lam_seg)
...
esttab land_du2 land_duhe2 land_mfdu2 land_mf2 land_mfhe2 land_he2, ///
	...
	// Eli: price_he2 -> land_he2
* export table version 	
esttab land_du2 land_duhe2 land_mfdu2 land_mf2 land_mfhe2 land_he2 using "$RDPATH/land_price_char_table_onlysf.tex", replace keep(25.dist3) ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
	label mtitles("land_du" "land_duhe" "land_mfdu" "land_mf" "land_mfhe" "land_he") ///
	title("Assessed Land Value Per Squarefoot")	
...
{
local plot_list land_du land_duhe land_mfdu land_mf land_mfhe land_he
local suffix "coef_land_base_onlysf"
local l1_title "Log Land Price Per Squarefoot"
local b1_title "<- More restrictive  |  Less restrictive ->"
local b2_title "Distance to Boundary (miles)"
...
{
local plot_list land_du land_duhe land_mfdu land_mf land_mfhe land_he
local suffix "coef_land_char_onlysf"
local l1_title "Log Land Price"
local b1_title "<- More restrictive  |  Less restrictive ->"
local b2_title "Distance to Boundary (miles)"
...
{
local plot_list land_du land_duhe land_mfdu land_mf land_mfhe land_he
local suffix "coef_price_both_onlysf"
local l1_title "Log Land Price Per Squarefoot"
local b1_title "<- More restrictive  |  Less restrictive ->"
local b2_title "Distance to Boundary (miles)"
...
quietly eststo rent_mfdu2: reg log_mfrent ib26.dist3 i.lam_seg i.year $char_vars if mf_du == 1 & `regression_conditions', vce(cluster lam_seg)

quietly eststo rent_mf2: reg log_mfrent ib26.dist3 i.lam_seg i.year $char_vars if only_mf== 1 & `regression_conditions', vce(cluster lam_seg)

quietly eststo rent_mfhe2: reg log_mfrent ib26.dist3 i.lam_seg i.year $char_vars if mf_he == 1 & `regression_conditions', vce(cluster lam_seg)
...
quietly eststo rent_mfdu2_robust: reg log_mfrent ib26.dist3 i.lam_seg i.year $char_vars if mf_du == 1 & `regression_conditions', vce(robust)

quietly eststo rent_mf2_robust: reg log_mfrent ib26.dist3 i.lam_seg i.year $char_vars if only_mf== 1 & `regression_conditions', vce(robust)

quietly eststo rent_mfhe2_robust: reg log_mfrent ib26.dist3 i.lam_seg i.year $char_vars if mf_he == 1 & `regression_conditions', vce(robust)
...
* combine all
#delimit ;
graph combine rent_du rent_duhe rent_mfdu rent_mf rent_mfhe rent_he,
	rows(3) cols(2) ysize() xsize() iscale() imargin(0)
	graphregion(fc(white) lcolor(white))
	l1title("{bf:`l1_title'}", size(3) margin(t=0 b=0 l=0 r=1))
	b1title("`b1_title'", size(2))
...
* combine all
#delimit ;
graph combine rent_du2 rent_duhe2 rent_mfdu2 rent_mf2 rent_mfhe2 rent_he2,
	rows(3) cols(2) ysize() xsize() iscale() imargin(0)
	graphregion(fc(white) lcolor(white))
	l1title("{bf:`l1_title'}", size(3) margin(t=0 b=0 l=0 r=1))
	b1title("`b1_title'", size(2))
...
********************************************************************************
** Part 7: Vacant Land prices
* Part 7a: Vacant Land prices, baseline
* Part 7b: Vacant Land prices, characteristics (land characteristics)
********************************************************************************
...
* set regression conditions
local regression_conditions (year>=2010 & year<=2018) & (dist_both<=0.21 & dist_both>=-0.2) & res_typex != "Condominiums" & assd_landval!=0 & assd_bldgval==0 

* Part 7a: Vacant land value w/o characteristics
quietly eststo vacant_land_du: reg log_land ib26.dist3 i.lam_seg i.year if only_du==1 & `regression_conditions', vce(cluster lam_seg)
sum assd_landval if only_du == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex != "Condominiums" & assd_landval !=0 & assd_bldgval==0
sum assd_landval if only_du == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex != "Condominiums" & assd_landval !=0 & assd_bldgval==0
	
quietly eststo vacant_land_duhe: reg log_land ib26.dist3 i.lam_seg i.year if du_he == 1 & `regression_conditions', vce(cluster lam_seg)
sum assd_landval if du_he == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex != "Condominiums" & assd_landval !=0 & assd_bldgval==0
sum assd_landval if du_he == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex != "Condominiums" & assd_landval !=0 & assd_bldgval==0

quietly eststo vacant_land_mfdu: reg log_land ib26.dist3 i.lam_seg i.year if  mf_du == 1 & `regression_conditions', vce(cluster lam_seg)
sum assd_landval if mf_du == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex != "Condominiums" & assd_landval !=0 & assd_bldgval==0
sum assd_landval if mf_du == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex != "Condominiums" & assd_landval !=0 & assd_bldgval==0

quietly eststo vacant_land_mf: reg log_land ib26.dist3 i.lam_seg i.year if only_mf== 1 & `regression_conditions', vce(cluster lam_seg)
sum assd_landval if only_mf == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex != "Condominiums" & assd_landval !=0 & assd_bldgval==0
sum assd_landval if only_mf == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex != "Condominiums" & assd_landval !=0 & assd_bldgval==0

quietly eststo vacant_land_mfhe: reg log_land ib26.dist3 i.lam_seg i.year if mf_he == 1 & `regression_conditions', vce(cluster lam_seg)
sum assd_landval if mf_he == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex != "Condominiums" & assd_landval !=0 & assd_bldgval==0
sum assd_landval if mf_he == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex != "Condominiums" & assd_landval !=0 & assd_bldgval==0

quietly eststo vacant_land_he: reg log_land ib26.dist3 i.lam_seg i.year if only_he == 1 & `regression_conditions', vce(cluster lam_seg)
sum assd_landval if only_he == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex != "Condominiums" & assd_landval !=0 & assd_bldgval==0
sum assd_landval if only_he == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex != "Condominiums" & assd_landval !=0 & assd_bldgval==0

esttab vacant_land_du vacant_land_duhe vacant_land_mfdu vacant_land_mf vacant_land_mfhe vacant_price_he, ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
	label mtitles("land_du" "land_duhe" "land_mfdu" "land_mf" "land_mfhe" "land_he") ///
	title("Land Price baseline") 

* export table version 	
esttab vacant_land_du vacant_land_duhe vacant_land_mfdu vacant_land_mf vacant_land_mfhe vacant_price_he using "$RDPATH/vacant_land_price_table.tex", replace keep(25.dist3) ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
	label mtitles("land_du" "land_duhe" "land_mfdu" "land_mf" "land_mfhe" "land_he") ///
	title("Assessed Land Value of Vacant Land")	
	
*robust s.e.
quietly eststo vacant_land_du_robust: reg log_land ib26.dist3 i.lam_seg i.year if only_du==1 & `regression_conditions', vce(robust)
	
quietly eststo vacant_land_duhe_robust: reg log_land ib26.dist3 i.lam_seg i.year if du_he == 1 & `regression_conditions', vce(robust)

quietly eststo vacant_land_mfdu_robust: reg log_land ib26.dist3 i.lam_seg i.year if  mf_du == 1 & `regression_conditions', vce(robust)

quietly eststo vacant_land_mf_robust: reg log_land ib26.dist3 i.lam_seg i.year if only_mf== 1 & `regression_conditions', vce(robust)

quietly eststo vacant_land_mfhe_robust: reg log_land ib26.dist3 i.lam_seg i.year if mf_he == 1 & `regression_conditions', vce(robust)

quietly eststo vacant_land_he_robust: reg log_land ib26.dist3 i.lam_seg i.year if only_he == 1 & `regression_conditions', vce(robust)

esttab vacant_land_du_robust vacant_land_duhe_robust vacant_land_mfdu_robust vacant_land_mf_robust vacant_land_mfhe_robust vacant_price_he_robust, ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
	label mtitles("land_du" "land_duhe" "land_mfdu" "land_mf" "land_mfhe" "land_he") ///
	title("Land Price baseline, robust s.e.") 
	
		
* Part 7b: Land price w/ characteristis (need to control for soil characteristics here and amenities not house characteirstics)
quietly eststo vacant_land_du2: reg log_land ib26.dist3 i.lam_seg i.year $char_vars_land if only_du==1 & `regression_conditions', vce(cluster lam_seg)
	
quietly eststo vacant_land_duhe2: reg log_land ib26.dist3 i.lam_seg i.year $char_vars_land if du_he == 1 & `regression_conditions', vce(cluster lam_seg)

quietly eststo vacant_land_mfdu2: reg log_land ib26.dist3 i.lam_seg i.year $char_vars_land if  mf_du == 1 & `regression_conditions', vce(cluster lam_seg)

quietly eststo vacant_land_mf2: reg log_land ib26.dist3 i.lam_seg i.year $char_vars_land if only_mf== 1 & `regression_conditions', vce(cluster lam_seg)

quietly eststo vacant_land_mfhe2: reg log_land ib26.dist3 i.lam_seg i.year $char_vars_land if mf_he == 1 & `regression_conditions', vce(cluster lam_seg)

quietly eststo vacant_land_he2: reg log_land ib26.dist3 i.lam_seg i.year $char_vars_land if only_he == 1 & `regression_conditions', vce(cluster lam_seg)
	
esttab vacant_land_du2 vacant_land_duhe2 vacant_land_mfdu2 vacant_land_mf2 vacant_land_mfhe2 vacant_land_he2, ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
	label mtitles("land_du" "land_duhe" "land_mfdu" "land_mf" "land_mfhe" "land_he") ///
	title("Land Price w/ characteristics") 
	
*table version 
esttab vacant_land_du2 vacant_land_duhe2 vacant_land_mfdu2 vacant_land_mf2 vacant_land_mfhe2 vacant_price_he2 using "$RDPATH/vacant_land_price_char_table.tex", replace keep(25.dist3) ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
	label mtitles("land_du" "land_duhe" "land_mfdu" "land_mf" "land_mfhe" "land_he") ///
	title("Assessed Land Value of Vacant Land")	
	
*robust s.e.
quietly eststo vacant_land_du2_robust: reg log_land ib26.dist3 i.lam_seg i.year $char_vars_land if only_du==1 & `regression_conditions', vce(robust)
	
quietly eststo vacant_land_duhe2_robust: reg log_land ib26.dist3 i.lam_seg i.year $char_vars_land if du_he == 1 & `regression_conditions', vce(robust)

quietly eststo vacant_land_mfdu2_robust: reg log_land ib26.dist3 i.lam_seg i.year $char_vars_land if  mf_du == 1 & `regression_conditions', vce(robust)

quietly eststo vacant_land_mf2_robust: reg log_land ib26.dist3 i.lam_seg i.year $char_vars_land if only_mf== 1 & `regression_conditions', vce(robust)

quietly eststo vacant_land_mfhe2_robust: reg log_land ib26.dist3 i.lam_seg i.year $char_vars_land if mf_he == 1 & `regression_conditions', vce(robust)

quietly eststo vacant_land_he2_robust: reg log_land ib26.dist3 i.lam_seg i.year $char_vars_land if only_he == 1 & `regression_conditions', vce(robust)
	
esttab vacant_land_du2_robust vacant_land_duhe2_robust vacant_land_mfdu2_robust vacant_land_mf2_robust vacant_land_mfhe2_robust vacant_land_he2_robust, ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
	label mtitles("land_du" "land_duhe" "land_mfdu" "land_mf" "land_mfhe" "land_he") ///
	title("Land Price w/ characteristics, robust s.e.") 
...
** coefplots
* coefplots, vacant land values w/o characteristics
{
local plot_list vacant_land_du vacant_land_duhe vacant_land_mfdu vacant_land_mf vacant_land_mfhe vacant_land_he
local suffix "coef_vacant_land_base"
local l1_title "Log Land Price"
local b1_title "<- More restrictive  |  Less restrictive ->"
local b2_title "Distance to Boundary (miles)"
...
* combine all
#delimit ;
graph combine vacant_land_du vacant_land_duhe vacant_land_mfdu vacant_land_mf vacant_land_mfhe vacant_land_he,
	rows(3) cols(2) ysize() xsize() iscale() imargin(0)
	graphregion(fc(white) lcolor(white))
	l1title("{bf:`l1_title'}", size(3) margin(t=0 b=0 l=0 r=1))
	b1title("`b1_title'", size(2))
...
* coefplots, vacant land values w/ characteristics
{
local plot_list vacant_land_du vacant_land_duhe vacant_price_mfdu vacant_price_mf vacant_price_mfhe vacant_price_he
local suffix "coef_vacant_land_char"
local l1_title "Log Land Price"
local b1_title "<- More restrictive  |  Less restrictive ->"
local b2_title "Distance to Boundary (miles)"
...
* combine all
#delimit ;
graph combine vacant_land_du2 vacant_land_duhe2 vacant_land_mfdu2 vacant_land_mf2 vacant_land_mfhe2 vacant_land_he2,
	rows(3) cols(2) ysize() xsize() iscale() imargin(0)
	graphregion(fc(white) lcolor(white))
	l1title("{bf:`l1_title'}", size(3) margin(t=0 b=0 l=0 r=1))
	b1title("`b1_title'", size(2))
...
* coefplots, vacant land values both
{
local plot_list land_du land_duhe land_mfdu land_mf land_mfhe land_he
local suffix "coef_vacant_land_price_both"
local l1_title "Log Land Price"
local b1_title "<- More restrictive  |  Less restrictive ->"
local b2_title "Distance to Boundary (miles)"
