...
/*
*@Nick I think this is not needed for our current Table 1
...
**@Nick, I don't think we need these, I think means file was collapsed into everything necessary for counterfactual analysis, so this can be just Table 1 file. 
/*
********************************************************************************
