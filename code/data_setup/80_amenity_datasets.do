...
* closest river
preserve
	local nborfile = "$DATAPATH/rivers/rivers.dta"
...
* closest roads
preserve
	local nborfile = "$DATAPATH/roads/major_roads.dta"
	geonear prop_id warren_latitude warren_longitude using `nborfile' , neighbors(new_id lat lon) long nearcount(1) miles
...
* closest green space
preserve
	local nborfile = "$DATAPATH/green_space/green_space.dta"
	geonear prop_id warren_latitude warren_longitude using `nborfile' , neighbors(new_id lat lon) long nearcount(1) miles
...
* closest school
preserve
	local nborfile = "$DATAPATH/schools/schools.dta"
...
preserve
	local nborfile = "$DATAPATH/city_centroids/city_centroids.dta"
...
** save and clear
********************************************************************************
save "$DATAPATH/warren/warren_MAPC_all_unique_closest_stuff.dta", replace
clear all
