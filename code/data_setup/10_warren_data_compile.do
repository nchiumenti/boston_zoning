...
* 				
* Inputs:			MA_assessor_annual_expanded.dta
...
preserve
	...
	geoinpoly warren_latitude warren_longitude using "$DATAPATH/originals/cb_2018_25_cousub_500k_shp.dta"
	
	duplicates report prop_id
	
	duplicates tag prop_id, gen(dup_tag)
	
	merge m:1 _ID using "$DATAPATH/originals/cb_2018_25_cousub_500k.dta", keep(1 3) keepusing(NAME)
		drop _merge
