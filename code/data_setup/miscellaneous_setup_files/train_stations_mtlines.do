...
local name ="train_stations_mtlines" // <--- change when necessry
...
*
* Description:		calcs estimates around train stations using mt lines setup
* 				
* Inputs:		various
*				
* Outputs:		
...
drop if LINE == "SILVER" // <-- drop silver line bus routes

* assign train stations to their city/town
geoinpoly _CY _CX using "$SHAPEPATH/originals/cb_2018_25_cousub_500k_shp.dta"

* merge on the geoids for cities/towns
merge m:1 _ID using "$SHAPEPATH/originals/cb_2018_25_cousub_500k.dta"
	keep if _merge == 3

* tag data as an MBTA station 
gen mbta_stations = 1
