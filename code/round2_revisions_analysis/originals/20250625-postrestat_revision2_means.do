...
***Want to do relaxed/strict comparison across regulation type for unit characteristics global char_vars char1_lotsizeac1 char2_livingarea1 char3_bedrooms1 char4_bathfull1
...
*means @nick, check variable names 
*relaxed
...
* collapse to calc means (NEW VARIABLES), @nick check variable names 
collapse (mean) m_lotsize_lamseg=char1_lotsizeac1 m_livingarea_lamseg=char2_livingarea1 m_bedrooms_lamseg=char3_bedrooms1 m_bathrooms_lamseg=char4_bathfull1 (count) n_lotsize=char1_lotsizeac1 n_living=char2_livingarea1 n_bedrooms=char3_bedrooms1 n_bathrooms=char4_bathfull1, by(lam_seg relaxed)
