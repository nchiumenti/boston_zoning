...
local name = "analysis_town_comparisons_setup"  // <--- change when necessry
...
sum log_combrent1
	...
	// noisily assert `r(mean)' ==  7.547702495636594  // old assert mean
	// noisily assert `r(mean)' ==  7.547702495636593  // new assert mean from Eli
