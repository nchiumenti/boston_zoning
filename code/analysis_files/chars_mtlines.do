...
*				
* Outputs:			Table C.8, Figure 2, Figure C.11, Table C.9, Table C.10
*					Figure C.11, Figure C.5
*
* Created:			06/23/2021
* Updated:			01/20/2026
********************************************************************************
...
** RD graphs
********************************************************************************
** Char vars year==2018 & year_built>=1918
foreach char_var in $char_vars{
	...
	*[PAPER SOURCE]: For Table C.8, Figure 2 Subfigures (e)-(g), Figure C.11 Subfigure (c)	
	...
	*[PAPER SOURCE]: For Table C.8, Figure 2 Subfigure (h), Figure C.11 Subfigure (d)
	...
	*[PAPER SOURCE]: For Table C.8, Figure C.11 Subfigure (e)	
	...
	*[PAPER SOURCE]: For Table C.8, Figure C.11	Subfigure (h)
	...
	*[PAPER SOURCE]: For Figure 2 Subfigures (a)-(d), Figure C.11 Subfigure (a)
	* only_du
	#delimit ;
	coefplot 	
	...
	*[PAPER SOURCE]: For Figure C.11 Subfigure (f)
	* only_he
	#delimit ;
	coefplot 
		/* relaxed side graphing variables */
	...
	*[PAPER SOURCE]: For Figure 2 Subfigure (h), Figure C.11 Subfigure (d)
	* only_mf
	#delimit ;
	coefplot 
		/* relaxed side graphing variables */
	...
	*[PAPER SOURCE]: For Figure 2 Subfigure (i), Figure C.11 Subfigure (b)
	* du_he
	#delimit ;
	coefplot 
		/* relaxed side graphing variables */
	...
	*[PAPER SOURCE]: For Figure 2 Subfigures (e)-(g), Figure C.11 Subfigure (c)
	* mf_du
	#delimit ;
	coefplot 
		/* relaxed side graphing variables */
	...
	*[PAPER SOURCE]: For Figure C.11 Subfigure (e)
	* mf_he
	#delimit ;
	coefplot 
		/* relaxed side graphing variables */
...
** Char vars year==2018 & no year built restriction
foreach char_var in $char_vars{
	di "running coefplots for: `char_var'"
	...
	* regression stores
	*[PAPER SOURCE]: For Figure C.5 Subfigures (a)-(d) 
	quietly eststo `char_lab'_du: reg `char_var' ib26.dist3 i.lam_seg if only_du == 1 & `regression_conditions', vce(cluster lam_seg)
		*[PAPER SOURCE]: For Figure C.5 Subfigure (a)-(d) 
		sum `char_var' if only_du == 1 & year==2018  & (dist_both<=0 & dist_both>-0.02) & res_typex!="Condominiums"
	*[PAPER SOURCE]: For Figure C.5 Subfigure (i)	
	quietly eststo `char_lab'_duhe: reg `char_var' ib26.dist3 i.lam_seg if du_he == 1 & `regression_conditions', vce(cluster lam_seg)
		*[PAPER SOURCE]: For Figure C.5 Subfigure (i)	
		sum `char_var' if du_he == 1 & year==2018  & (dist_both<=0 & dist_both>-0.02) & res_typex!="Condominiums"
	*[PAPER SOURCE]: For Figure C.5 Subfigures (e)-(g)	
	quietly eststo `char_lab'_mfdu: reg `char_var' ib26.dist3 i.lam_seg if mf_du == 1 & `regression_conditions', vce(cluster lam_seg)
		*[PAPER SOURCE]: For Figure C.5 Subfigure (e)-(g)	
		sum `char_var' if mf_du == 1 & year==2018  & (dist_both<=0 & dist_both>-0.02) & res_typex!="Condominiums"
	*[PAPER SOURCE]: For Figure C.5 Subfigure (h) 	
	quietly eststo `char_lab'_mf: reg `char_var' ib26.dist3 i.lam_seg if only_mf== 1 & `regression_conditions', vce(cluster lam_seg)
		*[PAPER SOURCE]: For Figure C.5 Subfigure (h) 	
		sum `char_var' if only_mf == 1 & year==2018  & (dist_both<=0 & dist_both>-0.02) & res_typex!="Condominiums"
		
	esttab `char_lab'_du `char_lab'_duhe `char_lab'_mfdu `char_lab'_mf, ///
	se r2 indicate("Boundary f.e.=*lam_seg") ///
	label mtitles("only_du" "du_he" "mf_du" "only_mf") ////
