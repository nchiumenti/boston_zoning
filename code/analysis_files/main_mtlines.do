...
local name ="main_mtlines"  // <--- change when necessry
...
*				
* Outputs:			Figure 1, Figure C.3, Figure C.4, Figure 3, Figure C.6, 
*					Figure 4, Figure C.7 
*
* Created:			06/23/2021
* Updated:			01/14/2026
...
* [PAPER SOURCE]: For Figure 1, all subfigures
...
* [PAPER SOURCE]: For Figure C.3 Subfigure (a)
quietly eststo units_du: reg num_units1 ib26.dist3 i.lam_seg if only_du == 1 & `regression_conditions', vce(cluster lam_seg)

* [PAPER SOURCE]: For Figure C.3 Subfigure (b)	
quietly eststo units_duhe: reg num_units1 ib26.dist3 i.lam_seg if du_he == 1 & `regression_conditions', vce(cluster lam_seg)

* [PAPER SOURCE]: For Figure C.3 Subfigure (c)
quietly eststo units_mfdu: reg num_units1 ib26.dist3 i.lam_seg if mf_du == 1 & `regression_conditions', vce(cluster lam_seg)

* [PAPER SOURCE]: For Figure C.3 Subfigure (d)
quietly eststo units_mf: reg num_units1 ib26.dist3 i.lam_seg if only_mf== 1 & `regression_conditions', vce(cluster lam_seg)

* [PAPER SOURCE]: For Figure C.3 Subfigure (e)
quietly eststo units_mfhe: reg num_units1 ib26.dist3 i.lam_seg if mf_he == 1 & `regression_conditions', vce(cluster lam_seg)

* [PAPER SOURCE]: For Figure C.3 Subfigure (f)
quietly eststo units_he: reg num_units1 ib26.dist3 i.lam_seg if only_he == 1 & `regression_conditions', vce(cluster lam_seg)
...
* [PAPER SOURCE]: For Figure C.3, all Subfigures
...
* [PAPER SOURCE]: For Figure C.4 Subfigure (a)
quietly eststo units_du: reg num_units1 ib26.dist3 i.lam_seg if only_du == 1 & `regression_conditions', vce(cluster lam_seg)

* [PAPER SOURCE]: For Figure C.4 Subfigure (b)	
quietly eststo units_duhe: reg num_units1 ib26.dist3 i.lam_seg if du_he == 1 & `regression_conditions', vce(cluster lam_seg)

* [PAPER SOURCE]: For Figure C.4 Subfigure (c)
quietly eststo units_mfdu: reg num_units1 ib26.dist3 i.lam_seg if mf_du == 1 & `regression_conditions', vce(cluster lam_seg)

* [PAPER SOURCE]: For Figure C.4 Subfigure (d)
quietly eststo units_mf: reg num_units1 ib26.dist3 i.lam_seg if only_mf== 1 & `regression_conditions', vce(cluster lam_seg)

* [PAPER SOURCE]: For Figure C.4 Subfigure (e)
quietly eststo units_mfhe: reg num_units1 ib26.dist3 i.lam_seg if mf_he == 1 & `regression_conditions', vce(cluster lam_seg)

* [PAPER SOURCE]: For Figure C.4 Subfigure (f)
quietly eststo units_he: reg num_units1 ib26.dist3 i.lam_seg if only_he == 1 & `regression_conditions', vce(cluster lam_seg)
...
* [PAPER SOURCE]: For Figure C.4, all Subfigures
...
* [PAPER SOURCE]: For Figure 3 Subfigure (a), Figure 4 Subfigure (a), Table C.8
...
* [PAPER SOURCE]: For Figure 3 Subfigure (a)
...
* [PAPER SOURCE]: For Figure 3 Subfigure (c), Table C.8
...
* [PAPER SOURCE]: For Figure 3 Subfigure (c)
...
* [PAPER SOURCE]: For Figure 3 Subfigure (b), Figure 4 Subfigure (b), Table C.8
...
* [PAPER SOURCE]: For Figure 3 Subfigure (b)
...
* [PAPER SOURCE]: For Figure 3 Subfigure (d), Table C.8
...
* [PAPER SOURCE]: For Figure 3 Subfigure (d)
...
* [PAPER SOURCE]: For Figure C.6 Subfigure (a), Table C.8
...
* [PAPER SOURCE]: For Figure C.6 Subfigure (c), Table C.8
...
** robust s.e.
* [PAPER SOURCE]: For Figure 3 Subfigure (a), Figure 4 Subfigure (a)
...
* [PAPER SOURCE]: For Figure 3 Subfigure (b), Figure 4 Subfigure (b)
...
* [PAPER SOURCE]: For Figure C.6 Subfigure (a)
...
* [PAPER SOURCE]: For Figure C.6 Subfigure (c)
...
** Sales price w/ characteristis
* [PAPER SOURCE]: For Figure 4 Subfigure (a)
...
* [PAPER SOURCE]: For Figure 4 Subfigure (b)
...
* [PAPER SOURCE]: For Figure 3 Subfigures (a)-(d)
...
* [PAPER SOURCE]: For Figure 4 Subfigures (a) and (b)
...
* combine all
#delimit ;
graph combine price_du3 price_mfdu3,
	rows(3) cols(2) ysize() xsize() iscale() imargin(0)
	graphregion(fc(white) lcolor(white))
	l1title("{bf:`l1_title'}", size(3) margin(t=0 b=0 l=0 r=1))
	b1title("`b1_title'", size(2))
...
* [PAPER SOURCE]: For Figure 4 Subfigure (e)
...
* [PAPER SOURCE]: For Figure C.7 Subfigure (a)
...
* [PAPER SOURCE]: For Figure 4 Subfigure (f)
...
* [PAPER SOURCE]: For Figure C.7 Subfigure (b)
...
* [PAPER SOURCE]: For Figure C.7 Subfigure (c)
...
* [PAPER SOURCE]: For Figure C.7 Subfigure (d)
...
** coefplots
* coefplots, sales prices w/o characteristics
* [PAPER SOURCE]: For Figure 4 Subfigures (e)-(f), Figure C.7 all Subfigures
{
...
* [PAPER SOURCE]: For Figure 4 Subfigure (c)
...
* [PAPER SOURCE]: For Figure 4 Subfigure (d)	
...
** coefplots
* [PAPER SOURCE]: For Figure 3 Subfigures (e)-(f)
...
* [PAPER SOURCE]: For Figure 4 Subfigures (c)-(d)->
...
* combine all
#delimit ;
graph combine rent_du3 rent_duhe3,
	rows(3) cols(2) ysize() xsize() iscale() imargin(0)
	graphregion(fc(white) lcolor(white))
	l1title("{bf:`l1_title'}", size(3) margin(t=0 b=0 l=0 r=1))
	b1title("`b1_title'", size(2))
