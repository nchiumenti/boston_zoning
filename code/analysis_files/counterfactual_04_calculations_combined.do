...
* 				
* Inputs:			various outputs found in counterfactuals #2 and #3
*				
* Outputs:			Figure 5
*
* Created:			04/28/2025		
...
use "$SHAPEPATH/cb_2018_25_cousub_500k.dta", clear
...
* [PAPER SOURCE]: For Figure 5 Subfigure (b)
********************************************************************************
** rents maps
********************************************************************************
* create rent map
...
* [PAPER SOURCE]: For Figure 5 Subfigure (c)
********************************************************************************
** prices maps
********************************************************************************
* create prices map
...
* [PAPER SOURCE]: For Figure 5 Subfigure (a)
********************************************************************************
** units maps
********************************************************************************
