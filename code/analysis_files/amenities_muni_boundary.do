...
*					Zoning Regulations
*
* Description:		File is the same as amenities_mtlines.do except it compares
*					across town boundaries instead of zoning boundaries.
*
*					Calls analysis_town_comparisons_setup.do
*
*					There is a very long setup to this file because it required 
*					a setup file specific to the muni boundaries. You can set
*					this run to on/off using the scalar on line 74.
*
...
confirm file "$DOPATH/analysis_town_comparisons_setup.do"
...
********************************************************************************
********************************************************************************
** distance to highway ([PAPER SOURCE]: For Table C.2) 
********************************************************************************
capture noisily {
** regressions
...
quietly eststo road_mf: reg dist_road ib26.dist3 i.lam_seg i.year if year==2018 & (dist_both<=0.21 & dist_both>=-0.2 & only_mf== 1 & res_typex !="Condominiums") , vce(cluster city)  // could not be calculated due to small sample size, see paper note table C.2
...
********************************************************************************
** distance to river ([PAPER SOURCE]: For Table C.2)
********************************************************************************
capture noisily {
** regressions
...
********************************************************************************
** distance to green space ([PAPER SOURCE]: For Table C.2)
********************************************************************************
capture noisily {
** regressions
...
********************************************************************************
* distance to school ([PAPER SOURCE]: For Table C.2)
********************************************************************************
capture noisily {
** regressions
...
********************************************************************************
** distance to city center ([PAPER SOURCE]: For Table C.2)
********************************************************************************
capture noisily {
** regressions
...
********************************************************************************
** commuting distance to downtown distance (south station) ([PAPER SOURCE]: For Table C.2)
********************************************************************************
capture noisily {
** regressions
...
********************************************************************************
** Mean slope of lot ([PAPER SOURCE]: For Table C.2)
********************************************************************************
capture noisily {
** regressions
...
********************************************************************************
** percent of lot >15 degrees ([PAPER SOURCE]: For Table C.2)
********************************************************************************
capture noisily {
** regressions
...
********************************************************************************
** depth to restrictive layer ([PAPER SOURCE]: For Table C.2)
********************************************************************************
capture noisily {
** regressions
...
********************************************************************************
** mean percent sand ([PAPER SOURCE]: For Table C.2)
********************************************************************************
capture noisily {
** regressions
...
********************************************************************************
** mean percent clay ([PAPER SOURCE]: For Table C.2)
********************************************************************************
capture noisily {
** regressions
...
********************************************************************************
********************************************************************************
** National Walkability Index score ([PAPER SOURCE]: For Table C.2)
********************************************************************************
capture noisily {
** regressions
...
********************************************************************************
** Employment mix  (only tables) ([PAPER SOURCE]: For Table C.2)
********************************************************************************
capture noisily {
** regressions
