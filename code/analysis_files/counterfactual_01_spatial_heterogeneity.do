...
foreach l of local levels {
	...
	* for every <d> bandwidth
	quietly foreach d of numlist 0.02 0.2 {
		...
		* [PAPER SOURCE]: Regression results for Table D.1 (i=1), Table D.2 (i=3)
		********************************************************************************	
		** Part 2a: only_du
		********************************************************************************
...
*[PAPER SOURCE]: Saved and used in later file
********************************************************************************
** t statistics
********************************************************************************
...
* [PAPER SOURCE]: Saves and used in later file
********************************************************************************
** t statistics
********************************************************************************
* loop over different bandwidth
