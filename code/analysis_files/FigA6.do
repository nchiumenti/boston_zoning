...
*Figure A6d involves plotting mapc_minus_muni_minus_river_minus_roads_minus_attendance_minus_sd_minus_zo_new.shp and XXXmtlinesXXXAdd
...
*Figure A.6d (length) XXXmtlinesXXXAdd
tempfile figA6d
shp2dta using "$DATAPATH/boundary_selection/XXX.shp", database(`figA6d') coordinates(`figA6d') replace
