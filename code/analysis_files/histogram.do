...
*					Zoning Regulations
*
* Description:		Makes a bunch of histograms and scatter plots for use in 
*					paper. Note the final alpha-num sequence may have changed.
* 				
* Inputs:			within_town_analysis_data.dta
*				
* Outputs:			histogram_A3.gph (now A.4 in paper)
*					binscatter_A4.gph (now A.5 in paper)
*
* Created:			09/21/2021
* Updated:			01/31/2026
********************************************************************************
...
********************************************************************************
** [PAPER SOURCE] Histogram for figure A.4 in paper
********************************************************************************
** append on acs data
preserve 
...
********************************************************************************
** [PAPER SOURCE] BinScatter for figure A.5 in paper
********************************************************************************
