...
foreach l in mls height{
	egen frac_binding_`l'_10_2010 = mean(`l'_binding_10) if year_built>=2010 & year_built!=.
} 

* mf is separate 
by lam_seg, sort: egen frac_binding_mf_2010 = mean(mf_binding) if year_built>=2010 & year_built!=.

* all
* based on 20% buffer

foreach l in mls height{
	egen frac_binding_`l'_10_all_2010 = mean(`l'_binding_10_all) if year_built>=2010 & year_built!=.
} 


sum frac_binding_mls_10_2010, d
sum frac_binding_mls_10_all_2010, d

sum frac_binding_height_10_2010, d 
sum frac_binding_height_10_all_2010, d
...
foreach l in mls height{
	by yb_group, sort: egen frac_binding_`l'_10_yb = mean(`l'_binding_10)
} 

* mf is separate 
by yb_group, sort: egen frac_binding_mf_yb = mean(mf_binding)

* all
* based on 20% buffer

foreach l in mls height{
	by yb_group, sort: egen frac_binding_`l'_10_all_yb = mean(`l'_binding_10_all)
} 


graph bar frac_binding_mls_10_all_yb frac_binding_height_10_all_yb frac_binding_mf_2010_yb, over(yb_group)
*@Nick, where should we save this? 	
...
by height_group, sort: egen frac_binding_height_10_strictness = mean(height_binding_10)

by mls_group, sort: egen frac_binding_mls_10_strictness = mean(mls_binding_10) 

by mf_byright, sort: egen frac_binding_mf_strictness = mean(mf_binding)

* all
* based on 20% buffer


by height_group, sort: egen frac_binding_height_10_all_strictness = mean(height_binding_10_all)
 
by mls_group, sort: egen frac_binding_mls_10_all_strictness = mean(mls_binding_10_all)

twoway connected frac_binding_height_10_all_strictness height_group, xlabel(,valuelabel) ylabel("Average bindingness by group")

twoway connected frac_binding_mls_10_all_strictness mls_group, xlabel(,valuelabel) ylabel("Average bindingness by group")

twoway connected frac_binding_mf_strictness mf_byright, xlabel(,valuelabel) ylabel("Average bindingness by group")
*@nick, how should we save 
...
quietly eststo land_du: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if only_du==1 & `regression_conditions' & frac_binding_mls_10_all>0.15 & frac_binding_mls_10_all!=., vce(cluster lam_seg)
sum land_per_sqft if only_du == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_mls_10_all>0.15 & frac_binding_mls_10_all!=.
sum land_per_sqft if only_du == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_mls_10_all>0.15 & frac_binding_mls_10_all!=.
	
quietly eststo land_duhe: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if du_he == 1 & `regression_conditions' & frac_binding_mls_10_all>0.15 & frac_binding_mls_10_all!=. & frac_binding_height_10_all>0.15 & frac_binding_height_10_all!=., vce(cluster lam_seg)
sum land_per_sqft if du_he == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_mls_10_all>0.15 & frac_binding_mls_10_all!=. & frac_binding_height_10_all>0.15 & frac_binding_height_10_all!=.
sum land_per_sqft if du_he == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_mls_10_all>0.15 & frac_binding_mls_10_all!=. & frac_binding_height_10_all>0.15 & frac_binding_height_10_all!=.

*only density binding
quietly eststo land_duhe2: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if du_he == 1 & `regression_conditions' & frac_binding_mls_10_all>0.15 & frac_binding_mls_10_all!=., vce(cluster lam_seg)
sum land_per_sqft if du_he == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_mls_10_all>0.15 & frac_binding_mls_10_all!=.
sum land_per_sqft if du_he == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_mls_10_all>0.15 & frac_binding_mls_10_all!=.

quietly eststo land_mfdu: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if  mf_du == 1 & `regression_conditions' & frac_binding_mls_10_all>0.15 & frac_binding_mls_10_all!=. & frac_binding_mf>0.15 & frac_binding_mf!=., vce(cluster lam_seg)
sum land_per_sqft if mf_du == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_mls_10_all>0.15 & frac_binding_mls_10_all!=. & frac_binding_mf>0.15 & frac_binding_mf!=.
sum land_per_sqft if mf_du == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_mls_10_all>0.15 & frac_binding_mls_10_all!=. & frac_binding_mf>0.15 & frac_binding_mf!=.

*only density binding 
quietly eststo land_mfdu2: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if  mf_du == 1 & `regression_conditions' & frac_binding_mf>0.15 & frac_binding_mf!=., vce(cluster lam_seg)
sum land_per_sqft if mf_du == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_mf>0.15 & frac_binding_mf!=.
sum land_per_sqft if mf_du == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_mf>0.15 & frac_binding_mf!=.

quietly eststo land_mf: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if only_mf== 1 & `regression_conditions' & frac_binding_mf>0.15 & frac_binding_mf!=., vce(cluster lam_seg)
sum land_per_sqft if only_mf == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_mf>0.15 & frac_binding_mf!=.
sum land_per_sqft if only_mf == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_mf>0.15 & frac_binding_mf!=.

quietly eststo land_he: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if only_he == 1 & `regression_conditions' & frac_binding_height_10_all>0.15 & frac_binding_height_10_all!=., vce(cluster lam_seg), vce(cluster lam_seg)
sum land_per_sqft if only_he == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_height_10_all>0.15 & frac_binding_height_10_all!=., vce(cluster lam_seg)
sum land_per_sqft if only_he == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_height_10_all>0.15 & frac_binding_height_10_all!=., vce(cluster lam_seg)
	
esttab land_du land_duhe land_duhe2 land_mfdu land_mfdu2 land_mf land_he, ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
	label mtitles("land_du" "land_duhe" "land_duhe2" "land_mfdu" "land_mfdu2" "land_mf" "land_he") ///
	title("Assessed Land Value Per Squarefoot") 
	
* export table version 	
esttab and_du land_duhe land_duhe2 land_mfdu land_mfdu2 land_mf land_he using "$EXPORTPATH/land_price_table_bindingness_15.tex", replace keep(25.dist3) ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
	label mtitles("land_du" "land_duhe" "land_duhe2" "land_mfdu" "land_mfdu2" "land_mf" "land_he") ///
	title("Assessed Land Value Per Squarefoot")	
	
*robust s.e.
quietly eststo land_du_robust: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if only_du==1 & `regression_conditions' & frac_binding_mls_10_all>0.15 & frac_binding_mls_10_all!=., vce(robust)
	
quietly eststo land_duhe_robust: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if du_he == 1 & `regression_conditions' & frac_binding_mls_10_all>0.15 & frac_binding_mls_10_all!=. & frac_binding_height_10_all>0.15 & frac_binding_height_10_all!=., vce(robust)

*only density binding
quietly eststo land_duhe2_robust: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if du_he == 1 & `regression_conditions' & frac_binding_mls_10_all>0.15 & frac_binding_mls_10_all!=., vce(robust)

quietly eststo land_mfdu_robust: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if  mf_du == 1 & `regression_conditions' & frac_binding_mls_10_all>0.15 & frac_binding_mls_10_all!=. & frac_binding_mf>0.15 & frac_binding_mf!=., vce(robust)

*only density binding 
quietly eststo land_mfdu2_robust: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if  mf_du == 1 & `regression_conditions' & frac_binding_mf>0.15 & frac_binding_mf!=., vce(robust)

quietly eststo land_mf_robust: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if only_mf== 1 & `regression_conditions' & frac_binding_mf>0.15 & frac_binding_mf!=., vce(robust)

quietly eststo land_he_robust: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if only_he == 1 & `regression_conditions' & frac_binding_height_10_all>0.15 & frac_binding_height_10_all!=., vce(cluster lam_seg), vce(robust)

esttab land_du_robust land_duhe_robust land_duhe2_robust land_mfdu_robust land_mfdu2_robust land_mf_robust land_he_robust, ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
	label mtitles("land_du" "land_duhe" "land_duhe2" "land_mfdu" "land_mfdu2" "land_mf" "land_he") ///
...
quietly eststo land_du: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if only_du==1 & `regression_conditions' & frac_binding_mls_10_all>0.25 & frac_binding_mls_10_all!=., vce(cluster lam_seg)
sum land_per_sqft if only_du == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_mls_10_all>0.25 & frac_binding_mls_10_all!=.
sum land_per_sqft if only_du == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_mls_10_all>0.25 & frac_binding_mls_10_all!=.
	
quietly eststo land_duhe: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if du_he == 1 & `regression_conditions' & frac_binding_mls_10_all>0.25 & frac_binding_mls_10_all!=. & frac_binding_height_10_all>0.25 & frac_binding_height_10_all!=., vce(cluster lam_seg)
sum land_per_sqft if du_he == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_mls_10_all>0.25 & frac_binding_mls_10_all!=. & frac_binding_height_10_all>0.25 & frac_binding_height_10_all!=.
sum land_per_sqft if du_he == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_mls_10_all>0.25 & frac_binding_mls_10_all!=. & frac_binding_height_10_all>0.25 & frac_binding_height_10_all!=.

*only density binding
quietly eststo land_duhe2: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if du_he == 1 & `regression_conditions' & frac_binding_mls_10_all>0.25 & frac_binding_mls_10_all!=., vce(cluster lam_seg)
sum land_per_sqft if du_he == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_mls_10_all>0.25 & frac_binding_mls_10_all!=.
sum land_per_sqft if du_he == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_mls_10_all>0.25 & frac_binding_mls_10_all!=.

quietly eststo land_mfdu: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if  mf_du == 1 & `regression_conditions' & frac_binding_mls_10_all>0.25 & frac_binding_mls_10_all!=. & frac_binding_mf>0.25 & frac_binding_mf!=., vce(cluster lam_seg)
sum land_per_sqft if mf_du == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_mls_10_all>0.25 & frac_binding_mls_10_all!=. & frac_binding_mf>0.25 & frac_binding_mf!=.
sum land_per_sqft if mf_du == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_mls_10_all>0.25 & frac_binding_mls_10_all!=. & frac_binding_mf>0.25 & frac_binding_mf!=.

*only density binding 
quietly eststo land_mfdu2: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if  mf_du == 1 & `regression_conditions' & frac_binding_mf>0.25 & frac_binding_mf!=., vce(cluster lam_seg)
sum land_per_sqft if mf_du == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_mf>0.25 & frac_binding_mf!=.
sum land_per_sqft if mf_du == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_mf>0.25 & frac_binding_mf!=.

quietly eststo land_mf: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if only_mf== 1 & `regression_conditions' & frac_binding_mf>0.25 & frac_binding_mf!=., vce(cluster lam_seg)
sum land_per_sqft if only_mf == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_mf>0.25 & frac_binding_mf!=.
sum land_per_sqft if only_mf == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_mf>0.25 & frac_binding_mf!=.

quietly eststo land_he: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if only_he == 1 & `regression_conditions' & frac_binding_height_10_all>0.25 & frac_binding_height_10_all!=., vce(cluster lam_seg), vce(cluster lam_seg)
sum land_per_sqft if only_he == 1 & (year>=2010 & year<=2018) & (dist_both<=0.02 & dist_both>0) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_height_10_all>0.25 & frac_binding_height_10_all!=., vce(cluster lam_seg)
sum land_per_sqft if only_he == 1 & (year>=2010 & year<=2018) & (dist_both<=0 & dist_both>-0.02) & res_typex != "Condominiums" & assd_landval !=0 & frac_binding_height_10_all>0.25 & frac_binding_height_10_all!=., vce(cluster lam_seg)
...
* export table version 	
esttab and_du land_duhe land_duhe2 land_mfdu land_mfdu2 land_mf land_he using "$EXPORTPATH/land_price_table_bindingness_25.tex", replace keep(25.dist3) ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
	label mtitles("land_du" "land_duhe" "land_duhe2" "land_mfdu" "land_mfdu2" "land_mf" "land_he") ///
	title("Assessed Land Value Per Squarefoot")	
	
*robust s.e.
quietly eststo land_du_robust: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if only_du==1 & `regression_conditions' & frac_binding_mls_10_all>0.25 & frac_binding_mls_10_all!=., vce(robust)
	
quietly eststo land_duhe_robust: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if du_he == 1 & `regression_conditions' & frac_binding_mls_10_all>0.25 & frac_binding_mls_10_all!=. & frac_binding_height_10_all>0.25 & frac_binding_height_10_all!=., vce(robust)

*only density binding
quietly eststo land_duhe2_robust: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if du_he == 1 & `regression_conditions' & frac_binding_mls_10_all>0.25 & frac_binding_mls_10_all!=., vce(robust)

quietly eststo land_mfdu_robust: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if  mf_du == 1 & `regression_conditions' & frac_binding_mls_10_all>0.25 & frac_binding_mls_10_all!=. & frac_binding_mf>0.25 & frac_binding_mf!=., vce(robust)

*only density binding 
quietly eststo land_mfdu2_robust: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if  mf_du == 1 & `regression_conditions' & frac_binding_mf>0.25 & frac_binding_mf!=., vce(robust)

quietly eststo land_mf_robust: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if only_mf== 1 & `regression_conditions' & frac_binding_mf>0.25 & frac_binding_mf!=., vce(robust)

quietly eststo land_he_robust: reg log_land_per_sqft ib26.dist3 i.lam_seg i.year if only_he == 1 & `regression_conditions' & frac_binding_height_10_all>0.25 & frac_binding_height_10_all!=., vce(cluster lam_seg), vce(robust)
