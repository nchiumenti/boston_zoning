...
*					Zoning Regulations
*
* Description:		Replicates paper Table 1
*					Updated on 8/28 to restrict to within .2 miles of boundary
* 				
...
by boundary_type, sort: egen total_units = total(num_units1)

tab boundary_type total_units

sum lot_sizeac, d
sum lot_sizesqft, d

* [PAPER SOURCE] Table 1 
preserve 
