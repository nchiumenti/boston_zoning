...
* house prices, triangular kernel
...
esttab rent_du2 rent_duhe2 rent_he2 using "$EXPORTPATH/rents_table_5001400.tex", replace keep(25.dist3) se r2 ///
	indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
	label mtitles("rent_du2" "rent_duhe2" "rent_he2") ///
	title("Rents, not between $500 - $1400") 
...
esttab price_du2 price_duhe2 price_mfdu2 price_mf2 price_mfhe2 price_he2 using "$EXPORTPATH/salesprice_table_onlyACScontrols.tex", replace keep(25.dist3) se r2 ///
...
esttab rent_du2 rent_duhe2 rent_he2 using "$EXPORTPATH/rents_table_onlyACScontrols.tex", replace keep(25.dist3) se r2 ///
	indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
	label mtitles("rent_du2" "rent_duhe2" "rent_he2") ///
	title("Rents, w/ characteristics") 	
...
esttab price_du price_duhe price_mfdu price_mf price_mfhe price_he using "$EXPORTPATH/salesprice_table_relaxed2.tex", replace keep(25.dist3_2) ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*last_saleyr") interaction(" X ") ///
	label mtitles("price_du" "price_duhe" "price_mfdu" "price_mf" "price_mfhe" "price_he") ///
	title("Sales Prices baseline") 
...
esttab price_du price_duhe price_mfdu price_mf price_mfhe price_he using "$EXPORTPATH/salesprice_table_relaxed3.tex", replace keep(25.dist3_3) ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*last_saleyr") interaction(" X ") ///
	label mtitles("price_du" "price_duhe" "price_mfdu" "price_mf" "price_mfhe" "price_he") ///
	title("Sales Prices, relaxed 3") 
...
esttab price_du price_duhe price_mfdu price_mf price_mfhe price_he using "$EXPORTPATH/salesprice_table_relaxed4.tex", replace keep(25.dist3_4) ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*last_saleyr") interaction(" X ") ///
	label mtitles("price_du" "price_duhe" "price_mfdu" "price_mf" "price_mfhe" "price_he") ///
	title("Sales Prices, relaxed 4") 
...
esttab price_du price_duhe price_mfdu price_mf price_mfhe price_he using "$EXPORTPATH/salesprice_table_clear_boundaries.tex", replace keep(25.dist3) ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*last_saleyr") interaction(" X ") ///
	label mtitles("price_du" "price_duhe" "price_mfdu" "price_mf" "price_mfhe" "price_he") ///
	title("Sales Prices baseline") 
...
esttab rent_du rent_duhe rent_he using "$EXPORTPATH/rents_table_relaxed2.tex", replace keep(25.dist3_2) se r2 ///
	indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
	label mtitles("rent_du" "rent_duhe" "rent_he") ///
	title("Rents, baseline") 
...
esttab rent_du rent_duhe rent_he using "$EXPORTPATH/rents_table_relaxed3.tex", replace keep(25.dist3_3) se r2 ///
	indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
	label mtitles("rent_du" "rent_duhe" "rent_he") ///
	title("Rents, baseline") 
...
esttab rent_du rent_duhe rent_he using "$EXPORTPATH/rents_table_relaxed3.tex", replace keep(25.dist3_4) se r2 ///
	indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
	label mtitles("rent_du" "rent_duhe" "rent_he") ///
	title("Rents, relaxed 4") 
...
esttab rent_du rent_duhe rent_he using "$EXPORTPATH/rents_table_clear_boundaries.tex", replace keep(25.dist3) se r2 ///
	indicate("Boundary f.e.=*lam_seg" "Year f.e.=*year") interaction(" X ") ///
	label mtitles("rent_du" "rent_duhe" "rent_he") ///
	title("Rents, baseline") 
...
graph combine price_du price_duhe price_mfdu ,
	...
	graph save "final_graph_clustered" "$EXPORTPATH/`suffix'_all", replace;
#delimit cr	
...
esttab price_du2 price_duhe2 price_mfdu2 price_mf2 price_mfhe2 price_he2 using "$EXPORTPATH/salesprice_table_amenities_control_new.tex", replace keep(25.dist3) ///
	se r2 indicate("Boundary f.e.=*lam_seg" "Year f.e.=*last_saleyr") interaction(" X ") ///
	label mtitles("price_du2" "price_duhe2" "price_mfdu2" "price_mf2" "price_mfhe2" "price_he2") ///
	title("Sales Prices w/ amenities") 
