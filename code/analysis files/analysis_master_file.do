...
do "$DOPATH/counterfactual_01_spatial_heterogeneity"  // run on 3/13

do "$DOPATH/counterfactual_02_train_station_means.do"  // run on 3/13

do "$DOPATH/counterfactual_03_means.do"  // run on 3/13
