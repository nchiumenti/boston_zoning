...
*
* Description:		This is a secondary robustness focused file that tests the 
*                   model against various amenities indicators over municipality
*                   boundaries only to check if there is any discontinuity 
*                   across boundaries.
*
