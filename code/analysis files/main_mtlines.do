...
*					coef_units_1956_base_du.gph (pdf)
*					coef_units_1956_base_duhe.gph (pdf)
*					coef_units_1956_base_he.gph (pdf)
*					coef_units_1956_base_mf.gph (pdf)
*					coef_units_1956_base_mfdu.gph (pdf)
*					coef_units_1956_base_mfhe.gph (pdf)
*					coef_units_noyear_base_du.gph (pdf)
*					coef_units_noyear_base_duhe.gph (pdf)
*					coef_units_noyear_base_he.gph (pdf)
*					coef_units_noyear_base_mf.gph (pdf)
*					coef_units_noyear_base_mfdu.gph (pdf)
*					coef_units_noyear_base_mfhe.gph (pdf)
*					coef_price_base_du.gph (pdf)
*					coef_price_base_duhe.gph (pdf)
*					coef_price_base_he.gph (pdf)
*					coef_price_base_mf.gph (pdf)
*					coef_price_base_mfdu.gph (pdf)
*					coef_price_base_mfhe.gph (pdf)
*					coef_price_both_du.gph (pdf)
*					coef_price_both_mfdu.gph (pdf)
*					coef_land_base_du.gph (pdf)
*					coef_land_base_duhe.gph (pdf)
*					coef_land_base_he.gph (pdf)
*					coef_land_base_mf.gph (pdf)
*					coef_land_base_mfdu.gph (pdf)
*					coef_land_base_mfhe.gph (pdf)
*					coef_rent_base_du.gph (pdf)
*					coef_rent_base_duhe.gph (pdf)
*					coef_rent_base_he.gph (pdf)
*					coef_rent_both_du.gph (pdf)
*					coef_rent_both_duhe.gph (pdf)
*
* Created:			06/23/2021
* Updated:			03/18/2025
********************************************************************************
